...
if [[ "$TRAVIS_PULL_REQUEST" != "false" ]]; then     # on pull requests
    echo "Build on PR"
    FASTLANE_EXPLICIT_OPEN_SIMULATOR=2 bundle exec fastlane test project:"CRFSampleApp/CRFSampleApp.xcodeproj"  scheme:"CRFSampleApp"
    ...
    bundle exec fastlane ci_archive scheme:"CRFSampleApp" export_method:"app-store" project:"CRFSampleApp/CRFSampleApp.xcodeproj"
